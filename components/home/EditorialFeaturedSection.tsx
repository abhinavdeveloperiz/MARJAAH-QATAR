...
export function EditorialFeaturedSection({ locale }: EditorialFeaturedSectionProps) {
  ...
  return (
    <section className="py-24 md:py-36 px-6 sm:px-12 md:px-16 overflow-hidden" style={{ backgroundColor: "var(--bg-surface)", borderTop: "1px solid var(--border-color)", color: "var(--text-primary)" }}>
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center max-w-[1440px] mx-auto">
        ...
        >
          ...
          <h2 className="font-display text-5xl sm:text-6xl md:text-7xl leading-tight uppercase tracking-tight" style={{ color: "var(--text-primary)" }}>
            {isRTL ? (
              <>
                عتاد فائق الأداء <br />
          ...
          {/* Taupe Body Text */}
          <p className="text-base sm:text-lg font-sans leading-relaxed max-w-xl" style={{ color: "var(--text-secondary)" }}>
            {isRTL
          ...
          <div className="pt-4 flex flex-wrap items-center gap-6">
            <Link
              href={`/${locale}/shop`}
              className="group inline-flex items-center gap-4 text-xs font-sans font-bold tracking-widest uppercase transition-colors duration-300"
